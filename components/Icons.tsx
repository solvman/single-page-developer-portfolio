...
export function IconFrontendMentor({
  width = 26,
  height = 23,
  className,
}: IconProps) {
  const id = useId();
  const elementId = `FrontendMentor-${id}`;
  ...
  return (
    ...
    >
      <title id={elementId}>Frontend Mentor</title>
...
export function IconGitHub({ width = 25, height = 24, className }: IconProps) {
  const id = useId();
  const elementId = `GitHub-${id}`;
  ...
  return (
    <svg
      ...
      aria-labelledby={elementId}
    >
      <title id={elementId}>GitHub</title>
      <path
        fillRule="evenodd"
...
export function IconLinkedIn({
  ...
  return (
    <svg
      ...
      aria-labelledby={elementId}
    >
      <title id={elementId}>LinkedIn</title>
      <path
        fillRule="evenodd"
...
export function IconTwitter({ width = 24, height = 20, className }: IconProps) {
  const id = useId();
  const elementId = `Twitter-${id}`;
  ...
  return (
    <svg
      ...
      aria-labelledby={elementId}
    >
      <title id={elementId}>Twitter</title>
